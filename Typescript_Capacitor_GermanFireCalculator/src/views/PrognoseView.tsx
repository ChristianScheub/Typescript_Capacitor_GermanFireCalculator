      ...
      <div className="screen__content">
        ...
        <div className="prognose-hero">
          ...
          <div className="prognose-hero__bar">
            <div className="prognose-hero__bar-fill" style={{ "--width": `${progressWidth}%` } as React.CSSProperties} />
          </div>
        </div>
        ...
        <div className="milestone-list">
          <MilestoneCard
            ...
            year={currentYear}
            subtitle={`${t('prognosis.startpoint')} · ${netWorthFormatted} €`}
            variant="default"
          ...
          <MilestoneCard
            ...
            year={fireYear}
            subtitle={`${t('prognosis.withdrawalPossible')} · ${netSWRFormatted} € / Monat`}
            variant="fire"
          ...
          <MilestoneCard
            ...
            year={pensionYear}
            subtitle={`${t('prognosis.additionalIncome')} · +${pensionMonthlyFormatted} € / Monat`}
            variant="default"
